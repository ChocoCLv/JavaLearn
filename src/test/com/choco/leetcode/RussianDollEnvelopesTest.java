...
public class RussianDollEnvelopesTest {
    ...
    public void maxEnvelopes1() {
        ...
        int max = rde.maxEnvelopes(new int[][]{{5, 4}, {6, 4}, {6, 7}, {2, 3},{7,2}});
        assertEquals(max, 3);
    }
    ...
    public void maxEnvelopes2() {
        RussianDollEnvelopes rde = new RussianDollEnvelopes();
        int max = rde.maxEnvelopes(new int[][]{{1, 1}, {1, 1}, {1, 1}});
        assertEquals(max, 1);
    }
    ...
    public void maxEnvelopes4() {
        RussianDollEnvelopes rde = new RussianDollEnvelopes();
        int max = rde.maxEnvelopes(new int[][]{{17,20},{5,16},{12,17},{14,8},{2,6},{3,9},{6,6},{10,9},{18,3},{19,6},{12,19},{4,2},{3,19},{5,7}});
        assertEquals(max, 5);
    }

    @Test
    public void maxEnvelopes5() {
        RussianDollEnvelopes rde = new RussianDollEnvelopes();
        int max = rde.maxEnvelopes(new int[][]{{1, 2}, {1, 3}, {1, 4}});
        assertEquals(max, 1);
    }
}
